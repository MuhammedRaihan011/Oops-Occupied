...
$id=$_SESSION['id'];
$q="select tblproperty.*,tblinterest.idate,tblinterest.status as istatus from tblproperty,tblinterest where tblproperty.pId=tblinterest.pid and tblproperty.vId='$id' and tblinterest.status='approved'";
